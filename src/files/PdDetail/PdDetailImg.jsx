...
if( props){
  ...
  const [img, setimg] = useState(pic[0])
    ...
    // console.log(' prop deatail = ',pic[0]);
...
if(!props){
  ...
  return (
    ...
    <div className=' md:h-[500px]  mt-[30px]  md:w-[600px] flex justify-center items-center    '>

        <img className='ml-[30px]  h-[500px] ' src={img} alt='product' height='100%' />
     </div>
